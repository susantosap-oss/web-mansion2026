      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 border-t border-gray-100 pt-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            {listing.agentKantor && <p className="text-gray-500 truncate" style={{ fontSize: '8px', lineHeight: 1.1 }}>{listing.agentKantor}</p>}
  ...
  return (
    <div className={`card group property-card ${className}`}>
      ...
      <div className="p-4">
        ...
        <Link href={`/projects/${project.slug}`} aria-label={`${project.name}${project.location ? ` — ${project.location}` : ''}${project.city ? `, ${project.city}` : ''} (${project.slug.slice(-6)})`}>
